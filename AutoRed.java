...
//end of REV Robotics IMU initialization
    ...
    public void RedJewelKnockOff(boolean color){
    ...
    public void RightColumn(){
      DriveForwardEncoder(0.5, DriveInchesToTicks(48));
      ArmBack();
      mSystemState = SystemState.GLYPHS_HIGH;
      LowStack();
    ...
    public void CenterColumn(){
      DriveForwardEncoder(0.5, DriveInchesToTicks(52));
      ArmBack();
      mSystemState = SystemState.GLYPHS_HIGH;
      LowStack();
      SimpleGyroTurn(70,false);
      sleep(100);
      DriveForwardEncoder(0.5, DriveInchesToTicks(-10));
      SimpleGyroTurn(53,true);
      DriveForwardEncoder(0.5, DriveInchesToTicks(-4));
      ArmOpen();
      sleep(250);
    ...
    public void LeftColumn(){
      DriveForwardEncoder(0.5, DriveInchesToTicks(39));
      ArmBack();
      mSystemState = SystemState.GLYPHS_HIGH;
      LowStack();
      SimpleGyroTurn(115,false);
      sleep(100);
      DriveForwardEncoder(0.5, DriveInchesToTicks(-17));
      ArmOpen();
      sleep(250);
      DriveForwardEncoder(0.3, DriveInchesToTicks(2));
      HomeElevator();
